    ...
    <div class="blog-section section pt-100 pt-lg-80 pt-md-70 pt-sm-60 pt-xs-50 pb-100 pb-lg-80 pb-md-70 pb-sm-60 pb-xs-50">
        <div class="container">
            <div class="row">
                <div class="col-lg-3 order-lg-1 order-2">
                    ...
                    <div class="common-sidebar-widget">
                        ...
                        <ul class="sidebar-tag">
                            ...
                            <li><a href="#">Dầu Thơm</a></li>
                            <li><a href="#">Volcanic Clay 2018</a></li>
                            <li><a href="#">Tobacco</li>
                    ...
                    <!-- Single Sidebar End  -->
                    <!-- Single Sidebar Start  -->
                    <div class="common-sidebar-widget" style="float:right">
                ...
                <div class="col-lg-9 order-lg-2 order-1" style="float:right">
                              <div class="row">
                            <!-- Single Blog Start -->
                            
                                    <asp:DataList ID="DataList1" runat="server" DataKeyField="maTin" DataSourceID="SqlDataSource1">                         
                                    <ItemTemplate>
                                        <div class="blog col-lg-6 col-md-6 col-sm-6" style="float:right">
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [Blog]"></asp:SqlDataSource>
