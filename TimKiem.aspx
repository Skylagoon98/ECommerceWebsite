<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="TimKiem.aspx.cs" Inherits="TT_ShopJQK.TimKiem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <!-- Shop Section Start -->
                    ...
                    <div class="col-lg-3 order-lg-1 order-2">
                        ...
                        <div class="common-sidebar-widget">
                            ...
                            <ul class="sidebar-list">
                                ...
                                <li><a href="#"><i class="fa fa-angle-right"></i> Dầu thơm <span class="count"></span></a></li>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [ChiTietSanPham] WHERE ([tenSP] LIKE '%' + @tenSP + '%')">
            <SelectParameters>
