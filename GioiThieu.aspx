<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="GioiThieu.aspx.cs" Inherits="TT_ShopJQK.GioiThieu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <!-- Page Banner Section Start -->
        <div class="page-banner-section section bg-gray">
            <div class="container">
                <div class="row">
                    <div class="col" style="background-color:#bebebe">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="section-title text-center mb-40 mb-xs-20">
                            <h2> WELCOME TO <span> Gentle Shop </span> STORE </h2>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-feature feature-style-2 mb-30">
                            ...
                            <div class="content">
                                <h2> Free shipping </h2>
                                <p> Nội Thành Sài Gòn với tất cả các hoá đơn </p>
                            </div>
                        </div>
                        <!-- Single Feature End -->
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-feature feature-style-2 mb-30">
                            ...
                            <div class="content">
                                ...
                                <p> Quý khách muốn đổi có thể liên hệ lại với Shop </p>
                            </div>
                        </div>
                        <!-- Single Feature End -->
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-feature feature-style-2 mb-30 br-0">
                            ...
                            <div class="content">
                                <h2> Member Vip </h2>
                                <p> Được hưởng các chính sách ưu đãi khuyến mại VIP </p>
                            </div>
                        </div>
                        <!-- Single Feature End -->
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="about-us-img-wrapper mb-30 mb-xs-15">
                            <div class="about-us-image img-full">
                                <a href="#"><img src="Anh/Logo/GentleShopLogo.png" alt=""></a>
                            </div>
                        </div>
                        <!--About Us Image End-->
                    </div>
                    <div class="col-lg-6 col-12">
                        ...
                        <div class="about-us-content">
                            <h2> Nhà Sáng Lập </h2>
                            <p class="mb-20"> Bài tập lớn môn lập trình web: Website Bán Mỹ Phẩm Cho Nam Giới </p>
                            <p class="mb-20"> Chúng tôi rất hân hạnh được phục vụ quý khách. Sự hài lòng của quý khách là niềm hạnh phúc và vinh dự đối với chúng tôi. </p>
        ...
        <div class="about-us-team-area section pt-100 pt-lg-80 pt-md-70 pt-sm-60 pt-xs-50 pb-70 pb-lg-50 pb-md-40 pb-sm-30 pb-xs-20">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="section-title text-center mb-40 mb-xs-20">
                            <h2> Founder <span> & CEO </span> Võ Phú Định </h2>
                    ...
                    <div class="col-md-4 col-sm-6">
                        ...
                        <div class="single-team mb-30">
                            <div class="team-image img-full">
                                <a href="#"><img src="Anh/Logo/GentleCEO.JPG" alt=""></a>
                            </div>
                            <div class="team-content">
                                <div class="team-hover-info">
                                    <h2><a href="#"> Võ Phú Định </a></h2>
                    ...
                    <div class="col-12">
                        ...
                        <div class="single-testimonial-area">
                            <div class="testimonial-image">
                                <img src="Anh/Logo/GentleCEO.JPG" alt="">
                            </div>
