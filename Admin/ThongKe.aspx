        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ul class="breadcrumb">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [thongkehoadon]"></asp:SqlDataSource>
                    </li>
                </ul>
            </nav>
        </div>
        <div class="row">
            <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-danger card-img-holder text-white">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [thongkesanpham]"></asp:SqlDataSource>
                    <%--------------------------------%>
                </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-info card-img-holder text-white">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [thongkenguoidung]"></asp:SqlDataSource>
                    <%--------------------------------%>
                </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
                <div class="card bg-gradient-success card-img-holder text-white">
                    ...
                    <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [thongkedoanhthu]"></asp:SqlDataSource>
                    <%--------------------------------%>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <%---------------------------------%>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Height="257px" Width="895px">
                        <Columns>
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [thongkebanhang]"></asp:SqlDataSource>
