<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/QuanTri.Master" AutoEventWireup="true" CodeBehind="QuanLyUsers.aspx.cs" Inherits="TT_ShopJQK.Admin.QuanLyUsers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <!-- partial -->
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    ...
                    <asp:Button ID="btThem" CssClass="btn btn-gradient-primary btn-sm" PostBackUrl="~/Admin/ThemUsers.aspx"  runat="server" Text="Thêm User"/><br />
                      <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Height="343px" Width="935px">
                          <Columns>
        ...
        <SortedDescendingHeaderStyle BackColor="#00547E" />
                      ...
                      <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [Users]"></asp:SqlDataSource>
