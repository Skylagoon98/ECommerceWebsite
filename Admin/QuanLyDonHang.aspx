<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/QuanTri.Master" AutoEventWireup="true" CodeBehind="QuanLyDonHang.aspx.cs" Inherits="TT_ShopJQK.Admin.QuanLyDonHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <!-- partial -->
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Đơn Hàng</h4>
                      ...
                      <asp:GridView ID="grOrders" runat="server" DataKeyNames="ID" AutoGenerateColumns="False" Height="377px" Width="935px"
        ...
        <SortedDescendingHeaderStyle BackColor="#00547E" />
                  ...
                  <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [HoaDon]"></asp:SqlDataSource>
