                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <asp:Repeater ID="Rspt" runat="server" DataSourceID="SqlDataSource1" >
                                 ...
                                 <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [showChămSócDa]"></asp:SqlDataSource>
