                            ...
                            <div class="tab-pane fade show active" id="products">
                                ...
                                "autoplay": true
                                        ...
                                        <!-- Single Product End -->
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [showSanPhamHotSale]"></asp:SqlDataSource>
                                </div>
                            </div>
                                ...
                                <div class="row tf-element-carousel" data-slick-options='{
                                    ...
                                    <asp:Repeater ID="Repeater2" runat="server" DataSourceID="SqlDataSource2">
                                        ...
                                        <!-- Single Product End -->
                                            ...
                                            <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:GentleMenShopConnectionString %>" SelectCommand="SELECT * FROM [showSanPhamMoi]"></asp:SqlDataSource>
                                        </div>
                                        <!-- Single Product End -->
                                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="single-feature feature-style-2 mb-30">
                            ...
                            <div class="content">
                                ...
                                <p> Quý khách muốn đổi sản phẩm hoàn toàn có thể liên hệ lại với shop </p>
                            </div>
                        </div>
                        <!-- Single Faeture End -->
                    </div>
                ...
                <div class="row tf-element-carousel" data-slick-options='{
                    ...
                    <div class="blog col">
                        <div class="blog-inner">
                            ...
                            <div class="content">
                                ...
                                <a class="readmore" href="blog-details.html"> Đọc thêm </a>
                            </div>
                        </div>
                    </div>
                    <!-- Single Blog End -->
                    ...
                    <div class="blog col">
                        <div class="blog-inner">
                            ...
                            <div class="content">
                                <h3 class="title"><a href="blog-details.html"> Bí Quyết Cho Tóc Khỏe Đẹp </a></h3>
                                <ul class="meta">
                                    <li><i class="fa fa-calendar"></i><span class="date-time"><span class="date">20</span><span class="separator">-</span><span class="month"> Jul </span></span></li>
                                </ul>
                                <p>Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat </p>
                                <a class="readmore" href="Blog.aspx"> Đọc thêm </a>
                            </div>
                        </div>
                    </div>
                    <!-- Single Blog End -->
